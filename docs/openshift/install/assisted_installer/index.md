...
A step-by-step Assisted Installer [Installation Guide](../../../guides/openshift/install/assisted_installer/assisted.md) is available for you on this site under the [Guides](../../../guides/index.md) section among other installation guides. The guide uses the following:
