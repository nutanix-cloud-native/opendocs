...
## Validated versions
### Cluster-API
| CAPX   | CAPI v1.9.x | CAPI v1.10.x | CAPI v1.11.x | CAPI v1.12.x | CAPI v1.13.x |
|--------|-------------|--------------|--------------|--------------|--------------|
| v1.9.x | No          | No           | Yes          | Yes          | Yes          |
| v1.8.x | Yes         | Yes          | Yes          | Yes          | Yes          |
| v1.7.x | Yes         | Yes          | Yes          | Yes          | Yes          |
...
| CAPX   | 6.8 (STS) | 6.10 | 7.0 | 7.3 | 7.5 |
|--------|-----------|------|-----|-----|-----|
| v1.9.x | No        | No   | No  | No  | Yes |
| v1.8.x | No        | No   | No  | Yes | Yes |
| v1.7.x | Yes       | Yes  | Yes | Yes | Yes | 

!!! warning "Cloud-Init Compatibility with AOS 7.3"

    When using CAPX v1.9.x with AOS 7.3, operating systems that do not use cloud-config for cloud-init may experience issues. Ensure your OS images are configured to use cloud-config format for cloud-init to avoid compatibility problems.

### Prism Central

| CAPX   | pc.2023.x | pc.2024.x | pc.7.3 | pc.7.5 |
|--------|-----------|-----------|--------|--------|
| v1.9.x | No        | No        | No     | Yes    |
| v1.8.x | No        | No        | Yes    | Yes    |
| v1.7.x | Yes       | Yes       | Yes    | No     |
